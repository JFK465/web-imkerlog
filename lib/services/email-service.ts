...
const PROJECT_ID = "imkerlog";
const PROJECT_DOMAIN = "bienen-manager.de";
const PROJECT_DISPLAY_NAME = "BienenManager";
const PROJECT_PRIMARY_COLOR = "#C87B14";
const PROJECT_ACCENT_COLOR = "#4A9D5B";
const PROJECT_ADMIN_EMAIL = "info@bienen-manager.de";
const PROJECT_TAGLINE = "Dein digitales Imker-Logbuch für erfolgreiche Bienenzucht";
