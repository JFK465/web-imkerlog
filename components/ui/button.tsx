  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-button text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background hover:bg-accent hover:text-accent-foreground rounded-button",
        secondary:
        ...
        gradient:
          "gradient-honey text-white shadow-warm hover:shadow-glow hover:shadow-xl hover:-translate-y-1 transition-all duration-300 rounded-button",
      },
      size: {
        default: "h-10 px-6 py-2 rounded-button",
        sm: "h-9 rounded-button px-4",
        lg: "h-11 rounded-button px-8",
        xl: "h-14 rounded-button px-10 text-lg",
